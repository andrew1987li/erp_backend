    ...
    var bindParam = function () {
        ...
        run = function (param) {
            ...
            $("#search").click(function () {
                bindParam();
                form.submit_form("post", "/Ammas/Cms/UserComments");
            });
            ...
            $("#add").click(function () {
                form.add_variable("Entity.UserCommentId", 0);
                bindParam();
                form.submit_form("post", "/Ammas/Cms/UserCommentEdit");
            });

            $(":button[id*=\"edit_\"]").click(function () {
                var id = $(this).attr("id").split("_")[1];
                form.add_variable("Entity.UserCommentId", id);
                bindParam();
                form.submit_form("post", "/Ammas/Cms/UserCommentEdit");
            });
            ...
            $(":button[id*=\"delete_\"]").click(function () {
                ...
                modal("confirm", "確定要刪除 ?", {
                    Click_OK: function (e) {
                        ...
                        $.when($.ajax({
                            type: "post",
                            url: "/Ammas/Cms/AjaxUserCommentDelete",
                            data: { "Entity.UserCommentId": id }
                            ...
                            if (code > 0) {
                                ...
                                form.add_variable("Target", "/Ammas/Cms/UserComments");
