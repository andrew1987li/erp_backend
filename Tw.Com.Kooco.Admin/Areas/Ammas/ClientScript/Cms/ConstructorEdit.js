define([
    ...
    var run = function (param) {
        ...
        $(".js_back").click(function () {
            ...
            jForm.submit_form("post", "/Ammas/Cms/ConstructorList");
        });
        ...
        $("#btn_addType").click(function () {
            ...
            $.post("/Ammas/Cms/AjaxAddConstructorType", form2.serialize()).done(function (ajaxResult) {
                var target = (data.Entity.Id > 0) ? "/Ammas/Cms/ConstructorEdit" : "/Ammas/Cms/ConstructorList";
                var parameter = [
        ...
        $(".btn_addType").click(function () {
            ...
            form2.validate({
                ...
                form2.validate({
                    ...
                    submitHandler: function (form) {
                        var formData = form2.serialize();
                        $.post("/Ammas/Cms/AjaxConstructorEdit", form2.serialize()).done(function (ajaxResult) {
                            var target = (data.Entity.Id > 0) ? "/Ammas/Cms/ConstructorEdit" : "/Ammas/Cms/ConstructorList";
                            var parameter = [
                                "Entity.Id=" + data.Entity.Id,
                                "StartDate=" + data.StartDate,
            ...
            form1.validate({
                ...
                submitHandler: function (form) {
                    ...
                    $.post("/Ammas/Cms/AjaxConstructorEdit", form1.serialize()).done(function (ajaxResult) {
                        var target = (data.Entity.Id > 0) ? "/Ammas/Cms/ConstructorEdit" : "/Ammas/Cms/ConstructorList";
                        var parameter = [
                            "Entity.Id=" + data.Entity.Id,
                            "StartDate=" + data.StartDate,
