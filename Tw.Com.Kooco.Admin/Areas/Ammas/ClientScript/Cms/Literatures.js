    ...
    var bindParam = function () {
        ...
        run = function (param) {
            ...
            $("#search").click(function () {
                bindParam();
                form.submit_form("post", "/Ammas/Cms/Literatures");
            });
            ...
            $("#add").click(function () {
                form.add_variable("Entity.LiteratureId", 0);
                bindParam();
                form.submit_form("post", "/Ammas/Cms/LiteratureEdit");
            });

            $(":button[id*=\"edit_\"]").click(function () {
                var id = $(this).attr("id").split("_")[1];
                form.add_variable("Entity.LiteratureId", id);
                bindParam();
                form.submit_form("post", "/Ammas/Cms/LiteratureEdit");
            });
            ...
            $(":button[id*=\"delete_\"]").click(function () {
                ...
                modal("confirm", "確定要刪除 ?", {
                    Click_OK: function (e) {
                        ...
                        $.when($.ajax({
                            type: "post",
                            url: "/Ammas/Cms/AjaxLiteratureDelete",
                            data: { "Entity.LiteratureId": id }
                            ...
                            if (code > 0) {
                                ...
                                form.add_variable("Target", "/Ammas/Cms/Literatures");
