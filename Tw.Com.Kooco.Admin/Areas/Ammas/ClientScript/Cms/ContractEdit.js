define([
    ...
    var run = function (param) {
        ...
        $(".js_back").click(function () {
            ...
            jForm.submit_form("post", "/Ammas/Cms/ContractList");
        });

        //新增明細項目
        $(".js_addDetail").click(function () {
        ...
        form1.validate({
            ...
            submitHandler: function (form) {
                ...
                $.post("/Ammas/Cms/AjaxContractEdit", form1.serialize()).done(function (ajaxResult) {
                    var target = (data.Entity.Id > 0) ? "/Ammas/Cms/ContractEdit" : "/Ammas/Cms/ContractList";
                    var parameter = [
