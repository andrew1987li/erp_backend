    ...
    var 
        run = function (param) {
            ...
            $(".js_back").click(function () {
                ...
                jForm.submit_form("post", "/Ammas/Cms/Literatures");
            });
            ...
            form1.validate({
                ...
                submitHandler: function (form) {
                    ...
                    $.post("/Ammas/Cms/AjaxLiteratureEdit", formData, "json").done(function (ajaxResult) {
                        var target = (data.Entity.LiteratureId > 0) ? "/Ammas/Cms/LiteratureEdit" : "/Ammas/Cms/Literatures";
                        var parameter = [
                            "Entity.LiteratureId=" + data.Entity.LiteratureId,
