define([
    ...
    var run = function (param) {
        ...
        $(".js_back").click(function () {
            ...
            jForm.submit_form("post", "/Ammas/Cms/buildingList");
        });
        ...
        form1.validate({
            ...
            submitHandler: function (form) {
                ...
                $.post("/Ammas/Cms/AjaxbuildingEdit", form1.serialize()).done(function (ajaxResult) {
                    var target = (data.Entity.Id > 0) ? "/Ammas/Cms/buildingEdit" : "/Ammas/Cms/buildingList";
                    var parameter = [
