define([
    ...
    var run = function(param) {
        ...
        $(".js_back").click(function() {
            ...
            jForm.submit_form("post", "/Ammas/Cms/UserComments");
        });
        ...
        form1.validate({
            ...
            errorPlacement: function(error, element) {
                if (element.attr("name") === "Entity.Comment") {
                    error.insertBefore('textarea[name="Entity.Comment"]');
                } else {
            ...
            submitHandler: function(form) {
                ...
                //return;
                $.post("/Ammas/Cms/AjaxUserCommentEdit", form1.serialize()).done(function (ajaxResult) {
                    var target = (data.UserCommentId > 0) ? "/Ammas/Cms/UserCommentEdit" : "/Ammas/Cms/UserComments";
                    var parameter = [
                        "Entity.UserCommentId=" + data.UserCommentId,
        ...
        $("#fileupload").fileupload({
            ...
            formData: { imgFolder: "UserComment" },
            autoUpload: true,
            singleFileUploads: true,
                ...
                //$.ajax({
                //    type: "post",
                //    url: "/Ammas/Cms/AjaxUserCommentDeleteFile",
        ...
        $.extend(settings, {
            rules: {
                ...
                'Entity.Title': { required: true },
                'Entity.Comment': { required: true },
