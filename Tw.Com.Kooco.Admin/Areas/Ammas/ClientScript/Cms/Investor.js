    ...
    var bindParam = function () {
        ...
        run = function (param) {
            ...
            $("#search").click(function () {
                bindParam();
                form.submit_form("post", "/Ammas/Cms/Investor");
            });
            ...
            $("#add").click(function () {
                form.add_variable("Entity.InvestorId", 0);
                bindParam();
                form.submit_form("post", "/Ammas/Cms/InvestorEdit");
            });

            $(":button[id*=\"edit_\"]").click(function () {
                var id = $(this).attr("id").split("_")[1];
                form.add_variable("Entity.InvestorId", id);
                bindParam();
                form.submit_form("post", "/Ammas/Cms/InvestorEdit");
            });
            ...
            $(":button[id*=\"delete_\"]").click(function () {
                ...
                modal("confirm", "確定要刪除 ?", {
                    Click_OK: function (e) {
                        ...
                        $.when($.ajax({
                            type: "post",
                            url: "/Ammas/Cms/AjaxInvestorDelete",
                            data: { "Entity.InvestorId": id }
                            ...
                            if (code > 0) {
                                ...
                                form.add_variable("Target", "/Ammas/Cms/Investor");
