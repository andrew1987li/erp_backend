define([
    ...
    var run = function (param) {
        ...
        $(".js_back").click(function () {
            ...
            jForm.submit_form("post", "/Ammas/Cms/InvoiceList");
        });
        ...
        form1.validate({
            ...
            submitHandler: function (form) {
                ...
                $.post("/Ammas/Cms/AjaxInvoiceEdit", form1.serialize()).done(function (ajaxResult) {
                    var target = (data.Entity.Id > 0) ? "/Ammas/Cms/InvoiceEdit" : "/Ammas/Cms/InvoiceList";
                    var parameter = [
