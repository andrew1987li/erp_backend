    ...
    var bindParam = function () {
        ...
        run = function (param) {
            ...
            $("#search").click(function () {
                bindParam();
                form.submit_form("post", "/Ammas/Cms/ConstructorList");
            });
            ...
            $("#add").click(function () {
                ...
                bindParam();
                form.submit_form("post", "/Ammas/Cms/ConstructorEdit");
            });
            ...
            $(":button[id*=\"delete_\"]").click(function () {
                ...
                modal("confirm", "確定要刪除 ?", {
                    Click_OK: function (e) {
                        ...
                        $.when($.ajax({
                            type: "post",
                            url: "/Ammas/Cms/AjaxConstructorDelete",
                            data: { "Entity.Id": id }
                            ...
                            if (code > 0) {
                                ...
                                form.add_variable("Target", "/Ammas/Cms/ConstructorList");
