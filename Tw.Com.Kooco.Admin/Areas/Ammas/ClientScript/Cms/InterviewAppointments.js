    ...
    var bindParam = function() {
        ...
        run = function(param) {
            ...
            $("#search").click(function() {
                bindParam();
                form.submit_form("post", "/Ammas/Cms/InterviewAppointments");
            });
            ...
            $(":button[id*=\"delete_\"]").click(function() {
                ...
                modal("confirm", "確定要刪除 ?", {
                    Click_OK: function(e) {
                        ...
                        $.when($.ajax({
                            type: "post",
                            url: "/Ammas/Cms/AjaxInterviewAppointmentDelete",
                            data: { "Entity.InterviewAppointmentId": id }
                            ...
                            if (code > 0) {
                                ...
                                form.add_variable("Target", "/Ammas/Cms/InterviewAppointments");
