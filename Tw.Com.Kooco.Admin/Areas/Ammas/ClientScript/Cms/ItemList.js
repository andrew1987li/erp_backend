    ...
    var bindParam = function () {
        ...
        run = function (param) {
            ...
            $("#search").click(function () {
                bindParam();
                form.submit_form("post", "/Ammas/Cms/ItemList");
            });
            ...
            $("#add").click(function () {
                ...
                bindParam();
                form.submit_form("post", "/Ammas/Cms/ItemEdit");
            });
                    ...
                    Click_OK: function (e) {
                        ...
                        $.when($.ajax({
                            ...
                            if (code > 0) {
                                ...
                                form.add_variable("Target", "/Ammas/Cms/ItemList");
